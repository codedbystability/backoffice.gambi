...
const DaiSvg = (props) => (
    ...
    <svg
        ...
        imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 444.44 444.44">
        <g id="Layer_x0020_1">
            <metadata id="CorelCorpID_0Corel-Layer"/>
            <path fill="#F5AC37" fillRule="nonzero"
            ...
            <path fill="#FEFEFD" fillRule="nonzero"
